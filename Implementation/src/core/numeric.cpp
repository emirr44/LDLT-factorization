...
/*
When a permutation is present an entry that is upper
in A may be lower in P A P', and is then only found from the other side of
// the diagonal.  So with a permutation A must store both triangles
*/
...
//  -- port of ldl_numeric, code by dr. Tim Davis --
